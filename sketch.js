...
function setup() {
  ...
  stand3 = new Stand(1010,100,150,10);
  polygon = new Polygon(50,200,6,30);
  ...
  block21= new Block(670,195,30,40);
  block22 = new Block(700,195,30,40);
  block23 = new Block(730,195,30,40);
  block24 = new Block(760,195,30,40);
  block25 = new Block(700,155,30,40);
